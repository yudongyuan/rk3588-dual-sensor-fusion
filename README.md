...
🛒 硬件采购与避坑指南 (价格参考：2026.3.24)

近期内存涨价，个人建议参考以下采购方案：

鲁班猫 RK3588 开发板 + MIPI屏 + 摄像头套件

💡 采购建议：推荐在闲鱼淘二手。近期由于内存条涨价，全新的板卡价格涨幅过大，买全新性价比极低（我半年前买的时候就已经是涨价趋势了）。

💰 价格参考：原价 ¥1189 ➡️ 现价约 ¥1669。

海曼 HTPA 热成像阵列传感器模块

💡 采购建议：同样建议在闲鱼单独购买。注意： 闲鱼上常见的模块通常是与串口通信板焊在一起的（本项目采用的是 I2C 通信），因此买回来后需要自己用电烙铁将传感器拆卸下来，这对焊接动手能力有一定要求。
（咸鱼上卖热成像的卖家什么也不懂，也没有硬件原理图和说明，只能靠自己去查）

💰 价格参考：原价 ¥30 ➡️ 现价约 ¥70。

外设与配件

💡 个人建议带屏幕购买套件。配合 Synergy 软件和一根网线，可以实现局域网内的键鼠共享，能极大提升开发效率。
